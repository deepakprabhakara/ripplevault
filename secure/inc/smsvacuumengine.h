...
#ifndef __SMSVACUUMENGINE_H__
#define __SMSVACUUMENGINE_H__
...
/*! 
  ...
  */
class CSmsVacuumEngine : public CActive, public MEngineNotifier
    {
public: // new methods
	CSecureAppUi &iAppUi;	
	void ExitApp();
...
/*!
  ...
  */
	static CSmsVacuumEngine* NewL(CSecureAppUi& aAppUi);

/*!
  @function NewLC
   
  @discussion Create a CSmsVacuumEngine object
  @param aConsole console to use for ui output
  @result a pointer to the created instance of CSMSEngine
  */
    static CSmsVacuumEngine* NewLC(CSecureAppUi& aAppUi);
...
/*!
  ...
  */
	CSmsVacuumEngine(CSecureAppUi& aAppUi);
