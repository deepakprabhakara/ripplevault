...
#ifndef __SMSLOCKENGINE_H__
#define __SMSLOCKENGINE_H__
...
/*! 
  ...
  */
class CSmsLockEngine : public CActive, public MEngineNotifier
    {
public: // new methods
	CSecureAppUi &iAppUi;	
	void ExitApp();
...
/*!
  ...
  */
	static CSmsLockEngine* NewL(CSecureAppUi& aAppUi);

/*!
  @function NewLC
   
  @discussion Create a CSmsLockEngine object
  @param aConsole console to use for ui output
  @result a pointer to the created instance of CSMSEngine
  */
    static CSmsLockEngine* NewLC(CSecureAppUi& aAppUi);
...
/*!
  ...
  */
	CSmsLockEngine(CSecureAppUi& aAppUi);
