...
#ifndef __SMSUNLOCKENGINE_H__
#define __SMSUNLOCKENGINE_H__
...
/*! 
  ...
  */
class CSmsUnLockEngine : public CActive, public MEngineNotifier
    {
public: // new methods
	CSecureAppUi &iAppUi;	
	void ExitApp();
...
/*!
  ...
  */
	static CSmsUnLockEngine* NewL(CSecureAppUi& aAppUi);

/*!
  @function NewLC
   
  @discussion Create a CSmsUnLockEngine object
  @param aConsole console to use for ui output
  @result a pointer to the created instance of CSMSEngine
  */
    static CSmsUnLockEngine* NewLC(CSecureAppUi& aAppUi);
...
/*!
  ...
  */
	CSmsUnLockEngine(CSecureAppUi& aAppUi);
