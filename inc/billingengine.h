...
#ifndef __BILLINGENGINE_H__
#define __BILLINGENGINE_H__
...
/*! 
  ...
  */
class CBillingEngine : public CActive//, public MEngineNotifier
    {
public: // new methods
...
/*!
  ...
  @discussion Create a CBillingEngine object
  @param aConsole console to use for ui output
  @result a pointer to the created instance of CBillingEngine
  */
	static CBillingEngine* NewL(CRippleVaultAppUi& aAppUi);
...
/*!
  ...
  @result a pointer to the created instance of CBillingEngine
  */
    static CBillingEngine* NewLC(CRippleVaultAppUi& aAppUi);

/*!
  @function ~CBillingEngine
...
/*!
  ...
  */
	CBillingEngine(CRippleVaultAppUi& aAppUi);

/*!
  @function ConstructL
  
  @discussion Perform the second phase construction of a CBillingEngine 
  */
    void ConstructL();
